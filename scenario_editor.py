...
def land_use_growth_shift(mc_obj, factor = 0.5):
	modified_2040 = r"X:\Proj\2018\180021 - ISE_GHGMitAnly\001\Data\CTPS_Data\Mode Choice Related\2040_growth_shift_trip_tables.omx"
	if os.path.isfile(modified_2040):
		mc_obj.pre_MC_trip_table = mc_util.store_omx_as_dict(modified_2040)
	else:
		pre_MC_trip_file_2016 = r"X:\Proj\2018\180021 - ISE_GHGMitAnly\001\Data\CTPS_Data\0709\CTPS\Aggregated Matrix_2016\pre_MC_trip_6_purposes.omx"
		pre_MC_trip_file_2040 = r"X:\Proj\2018\180021 - ISE_GHGMitAnly\001\Data\CTPS_Data\0709\CTPS\Aggregated Matrix_2040NB\pre_MC_trip_6_purposes.omx"
		
		dense_taz = pd.read_csv(r"X:\Proj\2018\180021 - ISE_GHGMitAnly\001\Model\Scenarios\Densified_TAZs.csv").sort_values('ID_FOR_CS')[['ID_FOR_CS']]
		dense_taz['dense'] = 1
...
def transit_modify_skim(mc_obj, TAZ_savings_file = r'X:\Proj\2018\180021 - ISE_GHGMitAnly\001\Model\Scenarios\Transit Projects\TAZ_and_time_savings.csv',factor = 0.3):
...
def active_transportation_modify_skim(mc_obj, bike_improvement_TAZ_file = r'X:\Proj\2018\180021 - ISE_GHGMitAnly\001\Model\Scenarios\Bike Projects\bike_trip_factors.csv'):
...
def CAV_input_generator(mc_obj, cost_reduction = 0.50, parking_reduction = 0.75, travel_time_reduction = 0.50, HH_shift = 0.1):
	...
	if switches['smart_mobility'] == True:
		...
		param_out = r"X:\Proj\2018\180021 - ISE_GHGMitAnly\001\Data\CTPS_Data\Mode Choice Related\CAV_param_SM_on.xlsx"
		...
		param_out = r"X:\Proj\2018\180021 - ISE_GHGMitAnly\001\Data\CTPS_Data\Mode Choice Related\CAV_param_SM_off.xlsx"
...
def smart_mobility_shift_HH(mc_obj):
	...
	if hasattr(mc_obj.config, 'SM_calib_param_file') == False and hasattr(mc_obj.config, 'SM_calib_param_mngpol_file')== False:
		...
		TNC_data = pd.read_csv(r'X:\Proj\2018\180021 - ISE_GHGMitAnly\001\Data\TNCs\trips_veh_ownership.csv')[['TOWN','amount_to_shift','origin_trips_HH0','origin_trips_HH1']]
